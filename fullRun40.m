...
FBS_Max = cell(1,10);
for i=1:5
    FBS_Max{i} = FemtoStation_dual_strip((i-1)*10+5,MUE_pos-15, MBS, mue, 5, 0);
end

for i=1:5
    FBS_Max{i+5} = FemtoStation_dual_strip((i-1)*10+5,MUE_pos+15, MBS, mue, 5, 1);
end
...
for i=1:8
    ...
    FBS_in = PA_exhaustive_search_par(FBS_in, MBS, mue, 11, i,femtocellPermutation,1e2, saveNum, 1);
end
